...
public class Filtros {
    ...
    long contarVueltasPorCircuito(ArrayList<Vuelta> vueltas, String nombreCircuito) {
    ...
    long contarPilotosPorEquipo(ArrayList<Vuelta> vueltas, String nombreEquipo) {
        return vueltas.stream()
    ...
    long contarVueltasMasRapidas(ArrayList<Vuelta> vueltas, double tiempoLimite) {
        return vueltas.stream()
    ...
    long contarCircuitosPorLongitud(ArrayList<Circuito> circuitos, double longitudMinima) {
